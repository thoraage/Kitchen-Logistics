...
case class Item(id: Option[Int], userId: Option[Int], productId: Int, itemGroupId: Int, created: Date = Dates.now)

case class ItemGroup(id: Option[Int], userId: Option[Int], name: String, created: Date = Dates.now)
